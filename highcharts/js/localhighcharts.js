    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            ...
            initPath: function(q, f, l) {
                ...
                function v(a, c) {
                    for (var b = (h - a.length) / d; 0 < b && b--;) k = a.slice().splice(a.length / r - d, d * r), k[0] = c[h - d - b * d], m && (k[d - 6] = k[d - 2], k[d - 5] = k[d - 1]), [].splice.apply(a, [a.length / r, 0].concat(k)), p && b--
                }
                f = f || "";
                var u, c = q.startX,
                    b = q.endX,
        ...
        h(B.prototype, {
            ...
            applyTextOutline: function(y) {
                ...
                if ((h = y[0]) && "none" !== h && a.svg) {
                    ...
                    for (b = y.length; b--;) c = y[b], "highcharts-text-outline" === c.getAttribute("class") && k(y, g.removeChild(c));
                    e = g.firstChild;
                    d(y, function(a, y) {
            ...
            text: function(a, g, c, w) {
                ...
                w || (a.xSetter = function(a, g, c) {
                    var w = c.getElementsByTagName("tspan"),
                        ...
                        d;
                    for (d = 0; d < w.length; d++) b = w[d], b.getAttribute(g) === h && b.setAttribute(g, a);
                    c.setAttribute(g, a)
                });
                return a
            },
    ...
    var V = function(a) {
        ...
        a.extend(G.prototype, {
            ...
            zoom: function(a, b) {
                ...
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (n(g) && (a < e && (a = e), a > d && (a = d)), n(c) && (b < e && (b = e), b > d && (b = d))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
        ...
        a.Series = a.seriesType("line", null, {
                ...
                if (!1 !== f && x && l === x && !m.cropped && !m.hasGroupedData && m.visible) v(b, function(a, b) {
                    ...
                    if (z && x > z) {
                        ...
                        if (h(n))
                            ...
                            if (t)
                                for (e = 0; e < x; e++) n = b[e], q[e] = n[0], D[e] = n.slice(1, t + 1);
                            else
            ...
            processData: function(b) {
                ...
                if (p && this.sorted && !x && (!m || e > m || this.forceCrop))
                    ...
                    else if (c[0] < z || c[e - 1] > q) h = this.cropData(this.xData, this.yData, z, q), c = h.xData, d = h.yData, h = h.start, g = !0;
            ...
            generatePoints: function() {
                ...
                this.options.keys = a;
                if (c && (k !== (d = c.length) || l))
                    for (r = 0; r < d; r++) r !== f || l || (r += k), c[r] && (c[r].destroyElements(), c[r].plotX = void 0);
                this.data = c;
                this.points = n
            },
        ...
        v(a.Chart.prototype, {
            ...
            update: function(a, d, f) {
                ...
                if (n) {
                    ...
                    "alignTicks" in n && (r = !0);
                    k(n, function(a, b) {
                        -1 !== c("chart." + b, p.propsRequireUpdateSeries) && (g = !0); - 1 !== c(b, p.propsRequireDirtyBox) && (p.isDirtyBox = !0)
                    });
    ...
    (function(a) {
        ...
        a.distribute = function(a, b) {
            ...
            for (a = t(a, function(a) {
                ...
                for (f = a.length; f--;) h = a[f], m = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2, h.pos = Math.min(Math.max(0, m - h.size * h.align), b - h.size);
                f = a.length;
            ...
            c.visible && (l.enabled || c._hasPointLabels) && (q(d, function(a) {
                ...
                if (n)
                    for (c.sortByAngle(b, d - .5), 0 < c.maxLabelDistance && (h = Math.max(0, A - F - c.maxLabelDistance), k = Math.min(A + F + c.maxLabelDistance, f.plotHeight), q(b, function(a) {
                        ...
                        }), a.distribute(p, k + r - h)), K = 0; K < n; K++) e = b[K], k = e.positionsIndex, g = e.labelPos, B = e.dataLabel, O = !1 === e.visible ? "hidden" : "inherit", N = h = g[1], p && E(p[k]) && (void 0 === p[k].pos ? O = "hidden" : (w = p[k].size, N = e.top + p[k].pos)), delete e.positionIndex, P = l.justify ? x[0] + (d ? -1 : 1) * (F + e.labelDistance) : c.getX(N < e.top + 2 || N > e.bottom - 2 ? h : N, d, e), B._attr = {
                        visibility: O,
                        align: g[6]
                    }, B._pos = {
                        x: P + l.x + ({
        ...
        B.prototype.hideOverlappingLabels = function(a) {
            ...
            for (n = 0; n < f; n++)
                for (v = a[n], q = n + 1; q < f; ++q)
                    if (u = a[q], v && u && v !== u && v.placed && u.placed && 0 !== v.newOpacity && 0 !== u.newOpacity && (c = v.alignAttr, b = u.alignAttr, m = v.parentGroup, d = u.parentGroup, h = 2 * (v.box ? 0 : v.padding || 0), c = k(c.x + m.translateX, c.y + m.translateY, v.width - h, v.height - h, b.x + d.translateX, b.y + d.translateY, u.width - h, u.height - h)))(v.labelrank < u.labelrank ? v : u).newOpacity = 0;
            H(a, function(a) {
                var b, c;
