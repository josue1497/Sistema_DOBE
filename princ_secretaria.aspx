<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="princ_secretaria.aspx.cs" Inherits="princ_secretaria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="header_bot">
        <div class="menu_block">
            <nav>
                <ul class="sf-menu">
                    <li class="current"><a href="princ_secretaria.aspx">Inicio</a></li>
                    ...
                    <li><a href="#">Registro</a>
                        <ul>
                            <li><a href="javascript:abrirVentana('/vistas/forms/registrarPersonal')">Registrar Personal</a></li>
                            <li><a href="/vistas/tablas/modificar_personal.aspx">Gestión de Personal</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <div class="container_12">
        <br>
        <h2 id="titleInicioSesion">Principal Secretaria</h2>
        <br>
        <table id="datos_admintvo">
            <tr>
                <td>
                    <label class="label">
                        Nombre: &nbsp;
