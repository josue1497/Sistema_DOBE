...
public partial class vistas_forms_evento_deportivo : System.Web.UI.Page
{
    Conexion con;
    ...
    protected void enviarBtn_click(object sender, EventArgs e)
    {
        if (validate())
        {
            ...
            if (con.insert("insert into dbo.solicitud_evento_dep values (" + Convert.ToInt32(Session["idAlumno"]) + ", " + Tipo_Evento.SelectedValue + ","
