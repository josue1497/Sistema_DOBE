<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reposos_docente.aspx.cs" Inherits="reposos" MasterPageFile="~/vistas/forms/FormMasterPage.master" %>
...
<asp:Content runat="server" ID="ReposoContent" ContentPlaceHolderID="MainContent">
    <form id="reposo_form" runat="server">
        <div>
            ...
            <asp:Label ID="periodoLabel" runat="server" Text="Período Académico: "></asp:Label>
