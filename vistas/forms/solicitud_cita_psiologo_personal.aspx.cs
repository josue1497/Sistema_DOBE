...
public partial class reposos : System.Web.UI.Page
{
    ...
    protected void enviarBtn_click(object sender, EventArgs e)
    {
        ...
        con.guardar("insert into dbo.solicitud_cita_psicologo (idAl, motivo, cod_estatus, is_docente, is_personal, periodo_academico) values (@alumno,@motivo,@estatus, @docente, @personal,@lapso);");
        ...
        con.Comando.Parameters.Add("@docente", SqlDbType.VarChar).Value = "N";
        con.Comando.Parameters.Add("@personal", SqlDbType.VarChar).Value = "S";
