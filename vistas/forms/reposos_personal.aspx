<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reposos_personal.aspx.cs" Inherits="reposos" MasterPageFile="~/vistas/forms/FormMasterPage.master" %>
    ...
    <form id="reposo_form" runat="server">
        <div>
            ...
            <asp:DropDownList ID="medicoList" runat="server" DataSourceID="medico" DataTextField="nombre" DataValueField="prima">
                <asp:ListItem Value="0" Text="Médico"></asp:ListItem>
            </asp:DropDownList>
            ...
            <asp:Label ID="periodoLabel" runat="server" Text="Período Academico: "></asp:Label>
