...
public partial class reposos : System.Web.UI.Page
{
    ...
    protected void enviarBtn_click(object sender, EventArgs e)
    {
        ...
        con.guardar("insert into dbo.solicitud_cita_odontologo (idAl, motivo, cod_estatus, is_personal, is_docente, periodo_academico) values (@alumno,@motivo,@estatus,@docente, @personal,@lapso);");
