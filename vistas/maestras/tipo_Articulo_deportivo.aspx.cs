...
public partial class vistas_maestras_tipo_Articulo_deportivo : System.Web.UI.Page
{
    ...
    protected void button_reg_Click(object sender, EventArgs e)
    {
        ...
        if (con.insert("insert into dbo.tipo_art_deportivo values('" + desc_articulo.Text.ToUpper() + "');"))
        {
