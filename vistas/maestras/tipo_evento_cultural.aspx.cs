...
public partial class vistas_maestras_tipo_evento_cultural : System.Web.UI.Page
{
    ...
    protected void button_reg_Click(object sender, EventArgs e)
    {
        ...
        if (con.insert("insert into dbo.tipo_evento_cult values('" + desc_evento.Text.ToUpper() + "');"))
        {
