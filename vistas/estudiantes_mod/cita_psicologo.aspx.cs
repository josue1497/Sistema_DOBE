...
{
    const string QUERY = "select cod_solicitud_cita_psicologo ID, motivo, " +
        " comentario_secretaria obs, cod_estatus estatus from dbo.solicitud_cita_psicologo  where ";
    string where;
    Conexion con;
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        string delete = "delete from dbo.solicitud_cita_psicologo where cod_solicitud_cita_psicologo=" + id;
        ...
        if (con.delete(delete))
        {
            ...
            Response.Redirect("cita_psicologo.aspx");
        }
    ...
    protected void BtnEditar_Click(object sender, EventArgs e)
    {
        ...
        string update = "update dbo.solicitud_cita_psicologo set  motivo='" + motivo.Text + "' where cod_solicitud_cita_psicologo=" + id;
