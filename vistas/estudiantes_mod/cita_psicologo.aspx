<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/estudiantes_mod/estudiantesMod.master" AutoEventWireup="true" CodeFile="cita_psicologo.aspx.cs" Inherits="vistas_estudiantes_mod_afiliacionEquipo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <br />
    <h2 class="title-seccion">Cita al Psicólogo</h2><br />
    <div class="grid">
