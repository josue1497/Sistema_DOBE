<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/estudiantes_mod/estudiantesMod.master" AutoEventWireup="true" CodeFile="instrumento_radio.aspx.cs" Inherits="vistas_estudiantes_mod_afiliacionEquipo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <br />
    <h2 class="title-seccion">Solicitud de Instrumento de Radio</h2><br />
    <div class="grid">
        <asp:GridView ID="afiliacion" runat="server" CellPadding="2" CellSpacing="5" Width="100%" EmptyDataText="La busqueda no arrojo resltado." AllowPaging="True" PageSize="20" AutoGenerateColumns="false" DataKeyNames="ID" OnDataBound="afiliacion_DataBound" OnPageIndexChanging="afiliacion_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Instrumento">
                    <ItemTemplate>
                        <asp:HiddenField ID="hiddenTipo" runat="server" Value='<%# Eval("equipo")%>' />
                        <asp:DropDownList ID="modTipo" runat="server" DataSourceID="equipods" DataTextField="desc_equipo" DataValueField="cod_equipo" ></asp:DropDownList>
                         <asp:SqlDataSource ID="equipods" runat="server" ConnectionString="<%$ ConnectionStrings:SISTEMA_DOBEConnectionString %>" SelectCommand="select cod_instrumento_radio cod_equipo, instrumento_radio desc_equipo from dbo.instrumento_radio"></asp:SqlDataSource>
                         </ItemTemplate>
                </asp:TemplateField>
