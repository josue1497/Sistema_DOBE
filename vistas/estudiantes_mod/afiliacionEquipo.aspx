<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/estudiantes_mod/estudiantesMod.master" AutoEventWireup="true" CodeFile="afiliacionEquipo.aspx.cs" Inherits="vistas_estudiantes_mod_afiliacionEquipo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <br />
    <h2 class="title-seccion">Afilicación a Equipos</h2><br />
    <div class="grid">
