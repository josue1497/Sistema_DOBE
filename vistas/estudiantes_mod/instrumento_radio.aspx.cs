...
{
    const string QUERY = "select cod_solicitud_instrumento_radio ID,  cod_instrumento_radio equipo , fecha_uso fecha, motivo, a.cod_estatus estatus " +
        " from dbo.solicitud_instrumento_radio a inner join dbo.estatus_solicitud b on (a.cod_estatus=b.cod_estatus) where ";
    string where;
    Conexion con;
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        string delete = "delete from dbo.solicitud_instrumento_radio where cod_solicitud_instrumento_radio=" + id;
        ...
        if (con.delete(delete))
        {
            ...
            Response.Redirect("instrumento_radio.aspx");
        }
    ...
    protected void BtnEditar_Click(object sender, EventArgs e)
    {
        ...
        string update = "update dbo.solicitud_instrumento_radio set cod_instrumento_radio=" + tipo.SelectedValue + ", motivo='" 
            + motivo.Text + "', fecha_uso='"+Convert.ToDateTime(fecha.Text).ToString("yyyy-MM-dd")+"' where cod_solicitud_instrumento_radio=" + id;
