<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/mod_personal/estudiantesMod.master" AutoEventWireup="true" CodeFile="visita_docente.aspx.cs" Inherits="hmedico" %>
...
<asp:Content ID="HMedico" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container_12">
        ...
        <div class="container_8">
            ...
            <asp:TextBox ID="Nombres" name="mombre" CssClass=" form-control " runat="server" Enabled="false" Width="500" required></asp:TextBox>&nbsp;<br>
            <br>
            <label for="titulo">Titulo:  </label>
            <asp:TextBox ID="Titulo" CssClass="form-control " name="titulo" Width="500" placeholder="Titulo para Identificarla Visita" runat="server" required></asp:TextBox>&nbsp;<br>
            <br>
