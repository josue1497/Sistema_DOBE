...
public partial class reportes_reportEdad : System.Web.UI.Page
{
    ...
    protected void btnReporte_Click(object sender, EventArgs e)
    {
        ...
        switch (dTipo.SelectedValue) {
            case "A":
                query = "select COUNT(P.idAl) cant, A.Cedula cedula, A.Fullnombre nombre from dbo.solicitud_cita_psicologo P "+
            ...
            case "D":
                query = "select COUNT(P.idAl) cant, A.Id_Docente cedula, A.Apellido1+' '+A.Apellido2+' '+A.Nombre1+' '+A.Nombre2 nombre "+
                    "from dbo.solicitud_cita_psicologo P inner join PRDPSMVAL.dbo.Docentes A on (P.idAl=A.IdDoc) "+
                ...
                break;
            case "P":
                query = "select COUNT(P.idAl) cant, A.cedula cedula, A.apellidos+' '+A.nombres nombre from dbo.solicitud_cita_psicologo P  " +
        ...
        Edad.Value = json;
        Session.Add("titulo", "Reporte Solicitudes Citas al Psicólogo");
