<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/reportes/masterReporte.master" AutoEventWireup="true" CodeFile="reporteSexo.aspx.cs" Inherits="reportes_reporteSexo" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $('#container').highcharts({
                    ...
                    title: {
                        text: 'Porcentaje de la población estuiantil que han solicitado resposo segun su Género'
                    },
                    tooltip: {
