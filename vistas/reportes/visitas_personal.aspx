<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/reportes/masterReporte.master" AutoEventWireup="true" CodeFile="visitas_personal.aspx.cs" Inherits="reportes_reportEdad" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $('#container').highcharts({
                    ...
                    title: {
                        text: 'Gráfico que muestra las diez principales razones por las el personal visita el Departamento'
                    },
                    tooltip: {
