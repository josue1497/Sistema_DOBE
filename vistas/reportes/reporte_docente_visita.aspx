<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/reportes/masterReporte.master" AutoEventWireup="true" CodeFile="reporte_docente_visita.aspx.cs" Inherits="reportes_reportEdad" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container_12">
        <div id="app" v-cloak>
            ...
            <br />
            <br />
            <h2 class="title-seccion">Reporte Visitas de los Docentes al Departamento</h2>
            <br />
     ...
     <h4><a href="imprimir_reporte/imprimir_visita_docente.aspx" target="_blank" style="text-align:center; font-size:x-large;">Imprimir Reporte</a></h4><hr />
    </div>
    <br> 
</asp:Content>
