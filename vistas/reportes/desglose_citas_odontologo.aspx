<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/reportes/masterReporte.master" AutoEventWireup="true" CodeFile="desglose_citas_odontologo.aspx.cs" Inherits="reportes_reportEdad" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container_12">
        <div id="app" v-cloak>
            ...
            <br />
            <br />
            <h2 class="title-seccion">Reporte Solicitudes Citas al Odontólogo</h2>
            <br />
