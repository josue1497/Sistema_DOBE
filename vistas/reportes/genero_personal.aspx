<%@ Page Title="" Language="C#" MasterPageFile="~/vistas/reportes/masterReporte.master" AutoEventWireup="true" CodeFile="genero_personal.aspx.cs" Inherits="reportes_reportEdad" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $('#container').highcharts({
                    ...
                    title: {
                        text: 'Porcentaje del Género del Personal Administrativo que ha solicitado reposos.'
                    },
                    tooltip: {
